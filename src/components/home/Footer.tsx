          ...
          <div className="flex gap-8 sm:gap-12 md:gap-16 flex-wrap">
             <div className="flex flex-col gap-2">
                {["Home", "Shop", "Fragrances"].map(link => (
                   <a key={link} href="#" className="text-[13px] md:text-[14px] font-light font-oxanium hover:underline">{link}</a>
                ))}
             </div>
             <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-4 w-full lg:max-w-[500px]">
           ...
           <div className="flex flex-col gap-4">
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                 ...
                 <button className="bg-[#653b09] text-white px-6 py-3 font-bold text-[14px] md:text-[16px] font-sans hover:bg-[#543107] transition-colors">
                    Subscribe
                 </button>
              </div>
